...
utils.percentage_in_cluster(
    app_details, utils.clusters_children, False
) / utils.percentage_in_cluster(app_details, utils.clusters_parents, False)

# %%
# Apps for literacy
p = utils.percentage_in_cluster(app_details, utils.clusters_literacy)
n = utils.percentage_in_cluster(app_details, utils.clusters_literacy, False)
n, p

# %%
p = utils.percentage_in_cluster(app_details, ["Numeracy development"])
n = utils.percentage_in_cluster(app_details, ["Numeracy development"], False)
n, p
